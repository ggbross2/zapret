...
#VERSION_URL = "https://nozapret.ru/version.json"  # URL для проверки обновлений
...
INFO_URL = "https://github.com/youtubediscord/zapret/blob/main/docs/whatfuckthis.md"  # URL с информацией о программе
