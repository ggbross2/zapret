...
from log import log
from tgram.tg_sender import send_file_to_tg
from tgram.tg_log_delta import get_client_id          # UUID устройства
from config.config import APP_VERSION                  # ← версия Zapret
