...
## О версиях
### Стабильные версии
Стабильные версии поставляются через лаунчер `ZapretSetup.exe`. Обновления доступно из под программы по кнопке "Обновить" или по ссылке: https://t.me/bypassblock/399
