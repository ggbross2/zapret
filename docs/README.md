...
### [🛡 Что это такое?](whatfuckthis.md) | [🚀 Как настроить под себя](https://github.com/youtubediscord/zapret/wiki) | [❓ FAQ](https://github.com/youtubediscord/zapret/discussions/93)
